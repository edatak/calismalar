...
class Instagram:
    ...
    def getFollowers(self):
        ...
        time.sleep(2)
        self.driver.find_elemet_by_xpath("//*[@id='mount_0_0_m4']/div/div/div[2]/div/div/div/div[1]/div[1]/div[2]/div[2]/section/main/div/header/section/ul/li[2]/a")
        time.sleep(2)

        dialog= self.driver.find_elemet_by_css_selector("div[role=dialog ul")
